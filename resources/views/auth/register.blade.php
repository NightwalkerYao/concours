        ...
        <div class="w-100 d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
          ...
          <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
              <!--begin::Page Title-->
              <h5 class="text-dark font-weight-bold my-1 mr-5">Inscription </h5>
              <!--end::Page Title-->
              <!--begin::Breadcrumb-->
              <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                <li class="breadcrumb-item">
                  <a href="{{ url()->full() }}" class="text-muted">Créer un compte</a>
                </li>
              </ul>
              <!--end::Breadcrumb-->
            </div>
          ...
          <div class="d-flex align-items-center">
            <a href="{{ route('login') }}" class="btn btn-light-primary font-weight-bolder">
            ...
            <div class="wizard wizard-5 d-flex flex-column flex-lg-row flex-row-fluid" id="kt_wizard" data-wizard-state="first">
              ...
              <div class="wizard-content bg-gray-100 d-flex flex-column flex-row-fluid py-15 px-5 px-lg-10">
                ...
                <div class="d-flex justify-content-center flex-row-fluid">
                  <form class="pb-5 w-100 w-md-450px w-lg-500px fv-plugins-bootstrap fv-plugins-framework" id="kt_form" method="post" enctype="multipart/form-data" action="{{ route('register') }}">
                    @csrf
                    <!--begin: Wizard Step 1-->
                    ...
                    <div class="pb-5" data-wizard-type="step-content">
                      ...
                      <div class="form-group fv-plugins-icon-container">
                        ...
                        <input type="email" class="form-control h-auto p-5 border-0 rounded-lg font-size-h6" name="email">
                        <div class="fv-plugins-message-container"></div>
                      </div>
                      <!--end::Form Group-->
                      <!--begin::Form Group-->
                    ...
                    <div class="pb-5" data-wizard-type="step-content">
                      ...
                      <div class="form-group fv-plugins-icon-container">
                        ...
                        <textarea class="form-control h-auto p-5 border-0 rounded-lg font-size-h6" name="motivation" rows="5"></textarea>
                        <div class="fv-plugins-message-container"></div>
                      </div>
                      <!--end::Form Group-->
                    </div>
