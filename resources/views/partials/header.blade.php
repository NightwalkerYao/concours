<div id="kt_header" class="header header-fixed">
  ...
  <div class="container">
    ...
    <div class="d-none d-lg-flex align-items-center mr-3">
      <!--begin::Logo-->
      <a href="{{ route('login') }}" class="mr-20">
        <img alt="Logo" src="/assets/media/logos/logo-letter-9.png" class="logo-default max-h-35px" />
      </a>
      <!--end::Logo-->
    </div>
    <!--end::Left-->
        ...
        <div class="quick-search quick-search-inline w-auto w-lg-200px" id="kt_quick_search_inline">
          ...
          <form method="get" class="quick-search-form">
            <div class="input-group rounded bg-light">
              ...
              <input type="text" class="form-control h-40px" placeholder="Chercher..." />
          ...
          <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
            ...
            <div class="d-flex align-items-center p-8 rounded-top">
              ...
              <div class="flex-grow-2">
                <span class="text-dark m-0 font-weight-bolder mr-3 font-size-h5">{{ Auth::user()->nom }}</span>
                <span class="text-muted font-weight-bold d-block">{{ strtoupper(Auth::user()->email) }}</span>
              </div>
              ...
              <a href="javascript:;" class="navi-item px-8">
                <div class="navi-link">
                  ...
                  <div class="navi-text">
                    ...
                    <div class="text-muted">Paramètres du profil</div>
                  </div>
                </div>
              </a>
              <!--end::Item-->
