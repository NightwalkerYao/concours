          ...
          <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
              ...
              <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                ...
                <li class="breadcrumb-item">
                  <a href="{{ route('create-client') }}" class="text-muted">Ajouter un Client</a>
                </li>
              </ul>
              <!--end::Breadcrumb-->
            </div>
            ...
            <div class="wizard wizard-5 d-flex flex-column flex-lg-row flex-row-fluid" id="kt_wizard" data-wizard-state="first">
                      ...
                      <div class="wizard-step" data-wizard-type="step" data-wizard-state="pending">
                        <div class="wizard-wrapper">
                          ...
                          <div class="wizard-label">
                            ...
                            <div class="wizard-desc">Téléphone</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="wizard-step" data-wizard-type="step" data-wizard-state="pending">
                        <div class="wizard-wrapper">
                          ...
                          <div class="wizard-label">
                            ...
                            <div class="wizard-desc">Photo, Signature &amp; Profession</div>
                          </div>
                        </div>
                      </div>
              ...
              <div class="wizard-content bg-gray-100 d-flex flex-column flex-row-fluid py-15 px-5 px-lg-10">
                ...
                <div class="d-flex justify-content-center flex-row-fluid">
                  <form class="pb-5 w-100 w-md-450px w-lg-500px fv-plugins-bootstrap fv-plugins-framework" id="kt_form" method="post" enctype="multipart/form-data" action="{{ route('create-client') }}">
                    @csrf
                    <!--begin: Wizard Step 1-->
                    <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                      <!--begin::Title-->
                      <div class="pb-10 pb-lg-15">
                        <h3 class="font-weight-bolder text-dark font-size-h2">Informations du Client</h3>
                      ...
                      <div class="form-group fv-plugins-icon-container">
                        ...
                        <input type="text" class="form-control h-auto p-5 border-0 rounded-lg font-size-h6" name="prenom">
                      ...
                      <div class="form-group fv-plugins-icon-container">
                        ...
                        <input type="text" class="form-control h-auto p-6 border-0 rounded-lg font-size-h6" name="nom">
                        <div class="fv-plugins-message-container"></div>
                      </div>
                      <!--end::Form Group-->
                      <!--begin::Form Group-->
                      <div class="form-group fv-plugins-icon-container">
                        ...
                        <div class="input-group date">
                          <input type="date" id="dob" min="{{ date("Y-m-d", strtotime("-90 years")) }}" max="{{ date("Y-m-d", strtotime("-16 years")) }}" class="form-control h-auto p-6 border-0 form-control-lg font-size-h6" name="date_naissance" readonly>
                        ...
                        <div class="radio-inline">
                          @foreach ($sexes as $sexe)
                            <label class="radio radio-lg">
                              <input type="radio" name="sexe_id" value="{{ $sexe->id }}"/>
                              <span></span>
                              {{ $sexe->libelle }}
                            </label>
                          @endforeach
                      ...
                      <!--begin::Form Group-->
                      <div class="form-group fv-plugins-icon-container">
                        <label class="font-size-h6 font-weight-bolder text-dark">N° de la CNI</label>
                        <input type="text" class="form-control h-auto p-6 border-0 rounded-lg font-size-h6" name="cni">
                        <div class="fv-plugins-message-container"></div>
                      </div>
                      <!--end::Form Group-->
                    </div>
                    ...
                    <div class="pb-5" data-wizard-type="step-content">
                      ...
                      <div class="pb-10 pb-lg-15">
                        <h3 class="font-weight-bolder text-dark font-size-h2">Informations du Client</h3>
                        <div class="text-muted font-weight-bold font-size-h4">Contact Téléphonique</div>
                      </div>
                      <!--end::Title-->
                      <!--begin::Form Group-->
                      <div class="form-group fv-plugins-icon-container">
                        <label class="font-size-h6 font-weight-bolder text-dark">N° de Téléphone</label>
                        <input type="text" class="form-control h-auto p-5 border-0 rounded-lg font-size-h6" name="telephone">
                        <div class="fv-plugins-message-container"></div>
                      </div>
                      <!--end::Form Group-->
                    </div>
                    ...
                    <div class="pb-5" data-wizard-type="step-content">
                      ...
                      <div class="pb-10 pb-lg-15">
                        <h3 class="font-weight-bolder text-dark font-size-h2">Informations du Client</h3>
                        <div class="text-muted font-weight-bold font-size-h4">Profession, Photo &amp; Signature</div>
                      </div>
                      <!--end::Title-->
                      <!--begin::Form Group-->
                      <div class="form-group fv-plugins-icon-container">
                        <label class="font-size-h6 font-weight-bolder text-dark">Profession</label>
                        <input type="text" class="form-control h-auto p-5 border-0 rounded-lg font-size-h6" name="profession">
                        <div class="fv-plugins-message-container"></div>
                      </div>
                      <!--end::Form Group-->
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="form-group row">
                            <label class="col-12 col-form-label">Photo du Client</label>
                            <div class="col-12">
                              <div class="text-center image-input image-input-empty image-input-outline" id="kt_image_5" style="background-image: url(/assets/media/users/blank.png)">
                        ...
                        <div class="col-md-6">
                          <!--begin::Form Group-->
                          <div class="form-group row text-align-right text-right">
                            <label class="col-12 col-form-label">Signature du Client</label>
                            <div class="col-lg-12">
                              <div class="text-center image-input image-input-empty" id="kt_image_6" style="background-image: url(/sets/media/users/blank.png)">
                                <div class="image-input-wrapper"></div>
                                <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Changer d'image">
                                  <i class="fa fa-pen icon-sm text-muted"></i>
                                  <input type="file" name="signature_file" accept=".png, .jpg, .jpeg">
                                  <input type="hidden" name="remove_signature">
                                </label>
                                <span class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="cancel" data-toggle="tooltip" title="" data-original-title="Annuler">
                                  <i class="ki ki-bold-close icon-xs text-muted"></i>
                                </span>
                                <span class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="remove" data-toggle="tooltip" title="" data-original-title="Retirer l'image'">
                                  <i class="ki ki-bold-close icon-xs text-muted"></i>
                                </span>
                              </div>
                              <span class="form-text text-muted">Images : JPG, JPEG, PNG</span>
                    ...
                    <div class="pb-5" data-wizard-type="step-content">
                      ...
                      <!--end::Title-->
                      <!--begin::Section-->
                      <h4 class="font-weight-bolder mb-3">Identité du Client:</h4>
                      ...
                      <!--end::Section-->
                      <!--begin::Section-->
                      <h4 class="font-weight-bolder mb-3">A propos du Client:</h4>
                      <div class="text-dark-50 font-weight-bold line-height-lg mb-8">
